...
export default class Slide {
  ...
  slidesConfig() {
    this.slideArray = [...this.slide.children].map((item) => {
      const positionElements = this.slidePosition(item);
      return {
        positionElements,
        item,
      };
  ...
  changeSlide(index) {
    ...
    this.moveSlide(this.slideArray[index].positionElements);
  ...
  changeActiveClass() {
    this.slideArray.forEach((itemNovo) =>
      itemNovo.item.classList.remove(this.activeClass)
    );
